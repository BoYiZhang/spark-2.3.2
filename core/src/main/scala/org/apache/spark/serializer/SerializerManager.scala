...
import org.apache.spark.util.{ByteBufferInputStream, ByteBufferOutputStream, JacksonUtils, Utils}
...
private[spark] class SerializerManager(
  ...
  def dataDeserializeStream[T](
    ...
    val autoPick = !blockId.isInstanceOf[StreamBlockId]
    val data =  getSerializer(classTag, autoPick)
      .newInstance()
